...
export namespace Prisma {
  ...
  */
  ...
  export type PredictionGroupByOutputType = {
    ...
    createdAt: Date
    starParams: JsonValue
    candidateParams: JsonValue
    signalParams: JsonValue
  ...
  export type PredictionSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    createdAt?: boolean
    starParams?: boolean
    candidateParams?: boolean
    signalParams?: boolean
    existingData?: boolean
    userId?: boolean
  ...
  export type PredictionOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "description" | "probability" | "classification" | "createdAt" | "starParams" | "candidateParams" | "signalParams" | "existingData" | "userId", ExtArgs["result"]["prediction"]>
  ...
  export type $PredictionPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    scalars: $Extensions.GetPayloadResult<{
      ...
      classification: string
      createdAt: Date
      starParams: Prisma.JsonValue
      candidateParams: Prisma.JsonValue
      signalParams: Prisma.JsonValue
      existingData: boolean
      userId: string
    }, ExtArgs["result"]["prediction"]>
    composites: {}
  ...
  interface PredictionFieldRefs {
    ...
    readonly description: FieldRef<"Prediction", 'String'>
    readonly probability: FieldRef<"Prediction", 'Float'>
    readonly classification: FieldRef<"Prediction", 'String'>
    readonly createdAt: FieldRef<"Prediction", 'DateTime'>
    readonly starParams: FieldRef<"Prediction", 'Json'>
    readonly candidateParams: FieldRef<"Prediction", 'Json'>
    readonly signalParams: FieldRef<"Prediction", 'Json'>
    readonly existingData: FieldRef<"Prediction", 'Boolean'>
  ...
  export type PredictionWhereInput = {
    ...
    description?: StringNullableFilter<"Prediction"> | string | null
    probability?: FloatFilter<"Prediction"> | number
    classification?: StringFilter<"Prediction"> | string
    createdAt?: DateTimeFilter<"Prediction"> | Date | string
    starParams?: JsonFilter<"Prediction">
    candidateParams?: JsonFilter<"Prediction">
    signalParams?: JsonFilter<"Prediction">
    existingData?: BoolFilter<"Prediction"> | boolean
  ...
  export type PredictionOrderByWithRelationInput = {
    ...
    createdAt?: SortOrder
    starParams?: SortOrder
    candidateParams?: SortOrder
    signalParams?: SortOrder
  ...
  export type PredictionScalarWhereWithAggregatesInput = {
    ...
    description?: StringNullableWithAggregatesFilter<"Prediction"> | string | null
    probability?: FloatWithAggregatesFilter<"Prediction"> | number
    classification?: StringWithAggregatesFilter<"Prediction"> | string
    createdAt?: DateTimeWithAggregatesFilter<"Prediction"> | Date | string
    starParams?: JsonWithAggregatesFilter<"Prediction">
    candidateParams?: JsonWithAggregatesFilter<"Prediction">
    signalParams?: JsonWithAggregatesFilter<"Prediction">
    existingData?: BoolWithAggregatesFilter<"Prediction"> | boolean
  ...
  export type PredictionCreateInput = {
    ...
    starParams: JsonNullValueInput | InputJsonValue
    candidateParams: JsonNullValueInput | InputJsonValue
    signalParams: JsonNullValueInput | InputJsonValue
    existingData: boolean
  ...
  export type PredictionUpdateInput = {
    ...
    candidateParams?: JsonNullValueInput | InputJsonValue
    signalParams?: JsonNullValueInput | InputJsonValue
    existingData?: BoolFieldUpdateOperationsInput | boolean
