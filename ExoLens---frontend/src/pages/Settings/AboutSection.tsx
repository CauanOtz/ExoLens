      ...
      <div className="about-content-wrapper" onClick={(e) => e.stopPropagation()}>
        ...
        <header className="about-hero">
          ...
          <div className="hero-content">
            <h1>Sobre o ExoLens</h1>
            <p>Uma jornada interativa pela vastidão do cosmos, explorando e criando novos mundos a partir de dados reais e imaginação.</p>
          </div>
        </header>
        ...
        <main className="about-main-content">
          ...
          <section className="about-section challenge-section">
            <img src={challengeImage} alt="Desafio de exploração espacial" className="section-image" />
            <div className="section-text">
              <h2>O Desafio Proposto</h2>
              <p>O desafio era criar uma plataforma visualmente impactante e educacional que permitisse aos usuários não apenas visualizar exoplanetas conhecidos, mas também gerar proceduralmente novos planetas com base em regras astrofísicas. O objetivo era unir ciência, design e tecnologia de ponta.</p>
            </div>
          </section>
