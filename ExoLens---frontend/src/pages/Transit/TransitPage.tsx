...
type Transit = { id: string; planet: string; date: string; depth: string; duration: string; snr: number };

const SAMPLE: Transit[] = [
  { id: 't1', planet: 'Kepler-62f', date: '2025-09-02', depth: '0.12%', duration: '3h 42m', snr: 12.3 },
  { id: 't2', planet: 'TRAPPIST-1b', date: '2025-08-28', depth: '0.32%', duration: '1h 12m', snr: 23.1 },
  { id: 't3', planet: 'HD 209458 b', date: '2025-07-12', depth: '1.64%', duration: '2h 05m', snr: 45.9 },
